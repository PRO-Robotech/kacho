...
// Тест-стаб compute/navigation для host-jest. ПУСТОЙ намеренно: rail-ассерты берут
// контент секций из агрегатного dashboard-navigation стаба, а этот стаб нужен
// ТОЛЬКО чтобы HostRail's Promise.allSettled(import("compute/navigation")) РЕЗОЛВИЛСЯ
