 ...
 * печенья заново СВОИМ хранилищем — там Secure к http снова не уходит. Обращений
 * к стенду с переадресацией у путей запроса набора нет; появится — перенос
 * придётся ставить и на них.
 *
