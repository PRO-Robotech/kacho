 ...
 * Вид узла назван ТИПОВЫМ АРГУМЕНТОМ запроса, а не приведением результата: запрос
 * обобщённый и по умолчанию отдаёт `HTMLElement`, у которого нет `value`, — а
 * утверждения ниже читают именно его.
 */
const field = () => screen.getByPlaceholderText<HTMLInputElement>(/ищется по всему списку/i);
