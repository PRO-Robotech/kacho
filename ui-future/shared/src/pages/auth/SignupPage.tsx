      ...
      >
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
          ...
          <Alert
            ...
            description={
              <>
                При первом входе автоматически создаётся <b>аккаунт</b> — ваша область в облаке — и стартовый{" "}
                <b>проект</b>. Вы становитесь его владельцем и можете приглашать пользователей, заводить сервисные
                аккаунты и выдавать роли.
              </>
            }
          />
