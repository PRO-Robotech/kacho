...
function cellOf(specId: string, row: Record<string, unknown>, projectId?: string) {
  const spec = REGISTRY[specId];
  const col = buildSpecColumns(spec, { projectId }).find((c) => c.header === "Имя")!;
  render(<MemoryRouter>{col.cell(row)}</MemoryRouter>);
}
