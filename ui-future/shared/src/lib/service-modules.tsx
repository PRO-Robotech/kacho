  ...
  // Не требует project context (живёт на уровне /iam/*).
  {
    ...
    items: [
      ...
      },
      {
        ...
        //
        // Пункт живёт в блоке IAM, а не в общем верхнем блоке рядом с
        // проектными квотами: тот ведёт на `/projects/:id/quotas` и без
        // выбранного проекта не ведёт никуда, а этот предел существует и когда
        // проектов нет ни одного.
        key: "iam-quotas",
        icon: <DashboardOutlined />,
        label: "Мои квоты",
        to: () => iamSeg("quotas"),
        matches: (p) => iamRe("quotas").test(p),
      },
      {
        key: "iam-projects",
        icon: <ClusterOutlined />,
