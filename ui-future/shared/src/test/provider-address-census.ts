 ...
 * исключение снимается одним изменением с этой ручкой (остаток #2874).
 *
 * Сама ось — ещё и половина суда соседей раздачи: конфигураций сборщика
 * `ui-future/deploy/console_serving_neighbours_test.go` не читает и отсылает
 * сюда. Поэтому снимающий ось решает и эту половину, а не одно исключение.
 *
