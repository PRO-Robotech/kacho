 ...
 */
// Пусто — и это ЦЕЛЬ, а не незаполненная заготовка: запись здесь означает модуль,
// чей прогон общего кода не проверяет. Освобождение compute сняла та же волна, что
// его завела: полоса #406 включила суиту вместе со сведением модуля, и запись
// потеряла предмет в тот же час. Проба «ведомость исключений самоистекает» ловит
// именно это — послабление, пережившее свою причину.
