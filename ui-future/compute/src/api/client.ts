...
//
// Ответ края о сессии (HTTP-роут самого api-gateway, вне proto) отсюда НЕ
// досягаем: его единственный читатель — клиент полосы формы консоли
// (`@shared/api/login-lane`, приёмка F8, условие C7), и за шимом этого
// приложения он не стоит.
//
