...
//
// ПОЧЕМУ ПЕРЕЧЕНЬ ВЫРОС НА ШЕСТНАДЦАТЬ СТРОК — не потому, что приложение стало
// звать больше. Реестр ресурсов сведён к единственному на всю консоль (#406), и
...
// маршруты; выросло не поведение, а то, что предикату видно. Тот же рост уже
// случался в этой шапке однажды — когда за шим уехали клиент, разбор отказа и
// справочник прав.
//
...
//
// Три ПОД-перечисления сети (её подсети, таблицы маршрутизации и группы
