...
// F8-46 · подключение стража в окружении dashboard: пакет общего набора не исполняет,
...
// каталог прогона: окружение dashboard надстраивается над общим, и именно цепочка
