...
// снимков, типов дисков и каталога размещения geo такого связывания нет вовсе,
// и склеенный здесь из `spec.apiPath` адрес спрашивал бы то, чего нет, — край
...
import { OperationsTable, operationColumnTitles, type Op, statusOf, type OperationStatus } from "@/components/molecules/OperationsTable";
