...
**измерен рабочим**: это достижимый шаг, и он заводится своей задачей, а не берётся
здесь заодно — вердикт по девяти корням даёт `check-federation-executes.mjs` и
сквозные пробы консоли, а не эта таблица.
