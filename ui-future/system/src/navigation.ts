...
export const SYSTEM_NAVIGATION: RemoteNavSection[] = [
  ...
  // Обслуживаются system-remote под /system/* (см. SystemPage SystemRoutes).
  {
    ...
    items: [
      ...
      // ЗДЕСЬ БЫЛ пункт «Пределы» — назначение величин администратором облака.
      // Снят вместе со своим предметом: служба, у которой он спрашивал и правил
      // величины, выпилена целиком, и производителя у этой поверхности нет ни
      // одного. Пункт вёл бы на страницу, отвечающую отказом при любом входе.
    ],
  },
