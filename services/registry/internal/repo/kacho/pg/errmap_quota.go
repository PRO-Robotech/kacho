...
// свободны для приложения. Значения те же, что у kacho-vpc и kacho-nlb, и это
...
// первых исходов: он и есть контракт — называет носителя, предел и вид. Для
// третьего исхода текст НЕ сохраняется: он про нашу схему, и арендатору о ней
// знать нечего (`security.md` §Hardening #1).
