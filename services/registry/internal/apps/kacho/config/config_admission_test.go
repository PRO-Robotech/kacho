...
func TestAdmissionKnobsArriveFromThePosture(t *testing.T) {
	...
	t.Setenv("KACHO_REGISTRY_ADMISSION_PUBLIC_READ_PER_SEC", "7")
	t.Setenv("KACHO_REGISTRY_ADMISSION_PUBLIC_MUTATION_PER_SEC", "3")
	t.Setenv("KACHO_REGISTRY_ADMISSION_PUBLIC_BURST_FACTOR", "2")
	t.Setenv("KACHO_REGISTRY_ADMISSION_PUBLIC_IN_FLIGHT", "5")
	t.Setenv("KACHO_REGISTRY_ADMISSION_INTERNAL_READ_PER_SEC", "70")
	t.Setenv("KACHO_REGISTRY_ADMISSION_INTERNAL_MUTATION_PER_SEC", "30")
	t.Setenv("KACHO_REGISTRY_ADMISSION_INTERNAL_BURST_FACTOR", "4")
	t.Setenv("KACHO_REGISTRY_ADMISSION_INTERNAL_IN_FLIGHT", "50")
...
func admissionRequiredEnv(t *testing.T) {
	t.Helper()
	t.Setenv("KACHO_REGISTRY_DB_PASSWORD", "не-пароль-а-заглушка")
}
