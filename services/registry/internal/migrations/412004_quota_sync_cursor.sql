...
CREATE TABLE IF NOT EXISTS kacho_registry.quota_sync_cursor (
...
COMMENT ON TABLE kacho_registry.quota_sync_cursor IS
...
COMMENT ON COLUMN kacho_registry.quota_sync_cursor.cursor IS
...
INSERT INTO kacho_registry.quota_sync_cursor (id) VALUES ('limits')
...
-- +goose StatementBegin
SET search_path TO kacho_registry, public;
DROP TABLE IF EXISTS kacho_registry.quota_sync_cursor;
-- +goose StatementEnd
