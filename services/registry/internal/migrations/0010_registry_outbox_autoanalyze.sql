...
-- Keep planner statistics fresh on the kacho_registry.registry_outbox queue table. Second half of the
...
ALTER TABLE kacho_registry.registry_outbox SET (
...
ANALYZE kacho_registry.registry_outbox;
...
ALTER TABLE kacho_registry.registry_outbox RESET (
