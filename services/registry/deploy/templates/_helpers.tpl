...
`global.kacho.registry.serviceAud`, — и его читает ещё и подчарт kaname.
...
{{/*
registry.trustDomain — ДОМЕН ДОВЕРИЯ установки, ОДНИМ написанием.
