  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/registry',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'services/registry/', href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/registry' },
