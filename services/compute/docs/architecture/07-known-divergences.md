...
**Что осталось.** Завести шаблон по образцу соседнего сервиса и включить его в боевом
профиле — добавить эшелон. Это отдельная работа по чарту, не условие корректности
авторизации.
