  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/compute',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'services/compute/', href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/compute' },
