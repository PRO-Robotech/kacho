...
func describe(
	...
	return servicecontract.New(servicecontract.Spec{
		...
		// одиночного запроса ей не годится. Подписки нет с #813 — она снята
		...
		StreamBudget: servicecontract.NotApplicable[time.Duration](
			"серверных стримов сервис не служит: подписка на журнал изменений снята вместе " +
				"со своей поверхностью (#813), других стримов у compute нет"),
		...
		// снятый вместе со своей поверхностью (#813). Носитель сверяет проводку
