...
func everyEdgeLive(t *testing.T) config.Config {
	...
	cfg := config.Config{
		...
		VPCGRPCAddr:             "kacho-vpc.kacho.svc.cluster.local:9090",
		VPCInternalGRPCAddr:     "kacho-vpc-internal.kacho.svc.cluster.local:9091",
		StorageInternalGRPCAddr: "kacho-storage-internal.kacho.svc.cluster.local:9091",
