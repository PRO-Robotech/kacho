...
Источник истины «что надо сделать» — **открытые GitHub Issues** в
`PRO-Robotech/kacho-compute` (баги/tech-debt/мелкие задачи) и
`PRO-Robotech/kacho-workspace` (кросс-репо эпики).

Метки: `bug` / `tech-debt` / `enhancement`; `blocked:kacho-kms` /
