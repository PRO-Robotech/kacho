...
// Предикат называется с РЕВИЗИЕЙ, иначе он устареет от коммита, который его же и
// закрывает: `git log -S 'VPC_NIC_MTLS' 6b1293713 -- services/compute/deploy/`
// → 0 коммитов (6b1293713 — ствол до правки; на HEAD их уже 1, и это правильно).
