...
`AttachDisk`, `DetachDisk`, `UpdateMetadata`, `AttachNetworkInterface`, `Relocate` и др.) —
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>kacho-storage</strong></td><td>Volume / Image / Snapshot / DiskType — блочное хранение; резолв источника загрузки и attach/detach тома</td></tr>
  </tbody>
</table>
