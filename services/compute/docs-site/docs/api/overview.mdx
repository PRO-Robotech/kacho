...
раздела (см. [Instance](/api/instance)).
...
Постраничный справочник: [Instance](/api/instance).
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>:9091</code></td><td>internal</td><td>Peer-сервисы и admin-UI (cluster-internal, mTLS)</td><td>Admin-CRUD справочника <code>MachineType</code>, outbox-stream <code>InternalWatchService</code></td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td><code>epd</code></td><td>Instance (legacy-форма)</td><td><code>epd0am5d8q1w4e7r2t6y</code></td></tr>
...
ресурсов: [Instance](/api/instance). Блочное хранение (Volume / Image / Snapshot /
DiskType) документировано на стороне владельца — kacho-storage.
:::
