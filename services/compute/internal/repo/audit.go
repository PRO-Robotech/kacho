...
// доставку ведёт дренаж, у него свои повторы и своя классификация отказов.
// Смешать запись с доставкой значило бы поставить успех мутации в зависимость
// от доступности приёмника журнала.
