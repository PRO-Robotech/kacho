...
CREATE TABLE IF NOT EXISTS public.quota_sync_cursor (
...
COMMENT ON TABLE public.quota_sync_cursor IS
...
COMMENT ON COLUMN public.quota_sync_cursor.cursor IS
...
INSERT INTO public.quota_sync_cursor (id) VALUES ('limits')
...
-- +goose StatementBegin
SET search_path TO public;
DROP TABLE IF EXISTS public.quota_sync_cursor;
-- +goose StatementEnd
