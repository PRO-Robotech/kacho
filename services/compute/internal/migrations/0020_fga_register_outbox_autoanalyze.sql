...
-- Keep planner statistics fresh on the compute_fga_register_outbox queue table. Second half of the
-- claim-throughput fix; migration 0019 (the ordering index) does not land without it.
--
...
ANALYZE compute_fga_register_outbox;
...
ALTER TABLE compute_fga_register_outbox RESET (
