...
CREATE INDEX IF NOT EXISTS compute_fga_register_outbox_claim_order_idx
    ON compute_fga_register_outbox (attempt_count, id)
...
DROP INDEX IF EXISTS compute_fga_register_outbox_claim_order_idx;
