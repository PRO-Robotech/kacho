...
-- `0036_project_resource_quotas.sql`.
...
COMMENT ON FUNCTION kacho_quota_count() IS
    ...
    'not "absent". Refusals are produced by kacho_quota_refuse: KQ001 = ceiling '
    'reached, KQ002 = no ceiling stated for this project and kind';
-- +goose StatementEnd
