...
type Repo interface {
	...
	List(ctx context.Context, projectID, filterExpr string, p ports.Pagination) ([]*domain.GuestAccessKey, string, error)
...
func (s *Service) List(ctx context.Context, projectID, filterExpr string, p ports.Pagination) ([]*domain.GuestAccessKey, string, error) {
