...
//     править их нельзя (ban #5), а собрать полный предмет в PL/pgSQL значит
//     завести ВТОРУЮ проекцию ресурса — на другом языке, рядом с первой, и
//     расходиться они будут молча;
...
// nlb с миграцией и решением про вторую проекцию, а не правка объявления журнала.
// У видов `nlb_listener` и `nlb_target_group` та же арифметика своя — считать её
// надо по своему предикату, а не переносить эту.
