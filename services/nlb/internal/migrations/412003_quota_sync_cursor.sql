...
CREATE TABLE IF NOT EXISTS kacho_nlb.quota_sync_cursor (
...
COMMENT ON TABLE kacho_nlb.quota_sync_cursor IS
...
COMMENT ON COLUMN kacho_nlb.quota_sync_cursor.cursor IS
...
INSERT INTO kacho_nlb.quota_sync_cursor (id) VALUES ('limits')
...
-- +goose StatementBegin
SET search_path TO kacho_nlb, public;
DROP TABLE IF EXISTS kacho_nlb.quota_sync_cursor;
-- +goose StatementEnd
