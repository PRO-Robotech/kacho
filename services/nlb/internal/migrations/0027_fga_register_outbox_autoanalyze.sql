...
-- Keep planner statistics fresh on the kacho_nlb.fga_register_outbox queue table. Second half of the
-- claim-throughput fix; migration 0026 (the ordering index) does not land without it.
--
...
ALTER TABLE kacho_nlb.fga_register_outbox SET (
...
ANALYZE kacho_nlb.fga_register_outbox;
...
ALTER TABLE kacho_nlb.fga_register_outbox RESET (
