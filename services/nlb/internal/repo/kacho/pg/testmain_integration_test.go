...
// call, and it is called 113 times here — so the package spent its whole budget
...
func newSharedDatabase(t testing.TB, fromTemplate bool) string {
	...
	name := fmt.Sprintf("kacho_nlb_t%04d", testDBSeq.Add(1))
