...
// одиночное чтение (`NetworkLoadBalancerService/Get` → `v_get`, permission_map.go и запись
...
// объект (`NetworkLoadBalancerService/ListOperations` → `v_list` на `nlb_network_load_balancer` — там вопрос
