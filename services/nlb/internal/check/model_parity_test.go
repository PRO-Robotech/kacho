...
// сверялся с ИСПОЛНЯЕМОЙ, а не с канонической: при расхождении двух копий он
...
// обязаны лежать в одном дереве, а здесь их больше не две. Свойство «каталог
// прав согласован с формой модели» он держит по-прежнему; свойство «служба
