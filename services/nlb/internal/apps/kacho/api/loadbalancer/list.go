...
// разрешённые id → сузь ими SQL») упирался в жёсткий предел перечисления у
// прежнего движка прав (1000, без продолжения) и делал собственные ресурсы
// тенанта невидимыми — см. package-doc
