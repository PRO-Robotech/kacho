    ...
    steps=[
        ...
        retry_until_present(Step(name="list-own", method="GET",
             ...
             test_script=[*assert_status(200),
                          ...
                          "pm.test('[D-40] owner sees own NLB in filtered List (read==enforce)', () => pm.expect(mine, JSON.stringify(lbs.map(i=>i.id))).to.be.an('object'));"]), "lfNlbId"),
    ...
    steps=[
        ...
        retry_until_present(Step(name="list-tg", method="GET",
             ...
             test_script=[*assert_status(200),
                          ...
                          "pm.test('[D-40] owner sees own TG in filtered List', () => pm.expect(mine, JSON.stringify(tgs.map(i=>i.id))).to.be.an('object'));"]), "lfTgId"),
