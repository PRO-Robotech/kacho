...
`00-unified-system-design.md` («nlb-примеры: общий prefix») **обе фактически
неверны**: `sub` и `adr` — **разные** префиксы, общего у них нет, и ни один из них
проверкой не сверяется. Исправлено в обоих документах.
