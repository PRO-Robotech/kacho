...
свидетельствует о себе: следующий, увидев в nlb журнал без подписки, иначе решит,
что подписку забыли завести. Журнал живёт независимо — его строки читают
перемещение балансировщика и перемещение целевой группы; снята была ПОДПИСКА, а не
журнал.
...
(#1043): поверхность и её читатель сняты, техника перенесена и удержана гейтом._
