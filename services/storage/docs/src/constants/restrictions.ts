...
export const RESTRICTIONS = {
  ...
  volumeSource: [
    ...
    'источник обязан быть READY («Snapshot <id> is not ready» / «Volume <id> is not ready»)',
  ...
  diskTypeBinding: [
    ...
    'Supersede односторонен: SUPERSEDED в ACTIVE не возвращается — вернуть класс в зону значит завести НОВУЮ ревизию',
  ],
  updateMask: [
