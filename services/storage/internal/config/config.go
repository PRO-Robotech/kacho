...
// Пробелы по краям срезаются: запись вида " spiffe://…" не совпала бы ни с одним
// сертификатом, и вместо понятного отказа старта получился бы молчаливый отказ в
// обслуживании законному отправителю.
