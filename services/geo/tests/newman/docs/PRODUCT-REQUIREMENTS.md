...
| REQ-GEO-10 | admin Create/Update/Delete → Operation{done:true} без result.error, ресурс материализуется | IRG-CR-CRUD-OK, IRG-UPD-CRUD-OK, IZN-CR-CRUD-OK, IZN-UPD-CRUD-STATUS |
...
| REQ-GEO-13 | zone status: explicit DOWN persists; omitted → DOWN (fail-safe) | IZN-CR-CONF-STATUS-DOWN, IZN-CR-CONF-STATUS-DEFAULT-DOWN |
...
| REQ-GEO-17 | public read: project-scope EXEMPT — аутентифицированный субъект БЕЗ грантов читает каталог (200) | GEO-REG-GT-AUTHZ-AMBIENT-OK, GEO-ZON-GT-AUTHZ-AMBIENT-OK |
...
| REQ-GEO-19 | Operation мутации завершена синхронно (done:true + metadata + response); malformed op-id → INVALID_ARGUMENT | GEO-IOP-SYNC-DONE-OK, GOP-GET-VAL-MALFORMED |
