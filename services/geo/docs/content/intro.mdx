...
<div className={hero.featureGrid}>
  ...
  <div className={hero.featureCard}>
    ...
    <span className={hero.featureBody}>AuthN обязательна везде; per-RPC authz Check через kacho-iam — на всех RPC, кроме публичного чтения справочника (задокументированное исключение).</span>
  </div>
  <div className={hero.featureCard}>
    <span className={hero.featureIcon}>📓</span>
