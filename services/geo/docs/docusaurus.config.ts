...
const config: Config = {
  title: 'Kachō Geo',
  tagline: 'Geography control plane — Region и Zone, источник истины о топологии платформы',

  url: 'https://geo.kacho.cloud',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'geoSidebar',
          label: 'Документация',
          position: 'left',
        },
        {
          href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/geo',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'services/geo/', href: 'https://github.com/PRO-Robotech/kacho/tree/main/services/geo' },
