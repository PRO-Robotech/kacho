...
// Smoke-test трансфера NetworkInterfaceRecord → *vpcv1.NetworkInterface.
// Регистрация — в init() пакета toproto; NetworkInterfaceRecord — repo-leaf
// entity (`kacho.NetworkInterfaceRecord`).
...
// заполняется только когда UsedByID != "".
