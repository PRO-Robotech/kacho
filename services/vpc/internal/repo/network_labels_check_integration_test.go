...
// helper-функцию kacho_labels_valid(). Эти тесты идут в обход
// domain.ValidateLabels (прямой INSERT через writer) и убеждаются, что DB-CHECK
// ловит нарушения cardinality / key-regex / value-length — backstop для bug'ов в
// app-коде и внешних writers.
//
