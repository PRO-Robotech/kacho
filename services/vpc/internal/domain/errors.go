...
// `corelib/validate`: единственное объявление формы и stdlib-чистый домен были
// недостижимы одновременно. Разрешилось выносом формы в `corelib/validate/nameform`
