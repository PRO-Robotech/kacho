...
-- Keep planner statistics fresh on the kacho_vpc.fga_register_outbox queue table. Second half of the
-- claim-throughput fix; migration 0020 (the ordering index) does not land without it.
--
...
ALTER TABLE kacho_vpc.fga_register_outbox SET (
...
ANALYZE kacho_vpc.fga_register_outbox;
...
ALTER TABLE kacho_vpc.fga_register_outbox RESET (
