...
func (h *Handler) List(ctx context.Context, req *vpcv1.ListNetworksRequest) (*vpcv1.ListNetworksResponse, error) {
	...
	if ferr := applystate.FillPage(ctx, h.applyState, resp.Networks,
		func(p *vpcv1.Network) string { return p.GetId() },
		func(p *vpcv1.Network, st *vpcv1.ApplyState) { p.ApplyState = st },
	); ferr != nil {
		return nil, ferr
	}
	return resp, nil
