...
func buildReadinessCheckers(pool *pgxpool.Pool, gate *bootgate.Gate, authzConn clients.Conn,
...
// одинаково.
func describeDiagnosticSurface(endpoint string, m *vpcmetrics.Metrics, agg *health.Aggregator,
