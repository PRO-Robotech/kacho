...
Контент выведен из:
- `proto/kacho/cloud/vpc/v1/*.proto` — контракт API (прежде отдельный репозиторий `kacho-proto`);
- `services/vpc/docs/engineering/architecture/` — data-flows, conventions, ER-диаграмма;
