...
export const RESTRICTIONS = {
  ...
  // nameGateway снят: форма имени у платформы ОДНА (`pkg/validate/nameform`), и
  // отдельного правила для шлюза не существует с #715. Запись жила как второе
  // место об одном предмете и объявляла различие, которого нет.
  nameGateway: [
    'та же форма, что у прочих ресурсов, — см. `name` выше',
  ],
