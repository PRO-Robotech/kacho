...
правится **один раз**. Набор (`CidrGroup`, идентификатор `cdg-…`) заводится в проекте
отдельно, правило ссылается на него, и правка состава набора действует во всех правилах,
