...
<table>
  ...
  <tbody>
    ...
    <tr><td>Protocol Buffers / Buf</td><td>Контракт API (<code>proto/</code>), кодогенерация</td></tr>
...
<table>
  ...
  <tbody>
    <tr><td><strong>services/vpc/</strong></td><td>Этот сервис: control-plane VPC + IPAM</td></tr>
    <tr><td><strong>proto/</strong></td><td>Центральные <code>.proto</code> + сгенерированные Go-stubs</td></tr>
    <tr><td><strong>pkg/</strong></td><td>Общие пакеты (ids, operations, db, outbox, ...)</td></tr>
    <tr><td><strong>gateway/</strong></td><td>Edge: gRPC-proxy + REST mux</td></tr>
    <tr><td><strong>services/iam/</strong></td><td>Account / Project / авторизация (per-RPC Check)</td></tr>
    <tr><td><strong>services/geo/</strong></td><td>Geography (Region / Zone) — валидация <code>zoneId</code></td></tr>
    <tr><td><strong>services/compute/</strong></td><td>Instance / Disk / Image / Snapshot (peer-консумер VPC)</td></tr>
  </tbody>
</table>
