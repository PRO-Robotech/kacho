...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>kacho-compute</strong></td><td>Instance / MachineType (peer-консумер VPC)</td></tr>
    <tr><td><strong>kacho-storage</strong></td><td>Volume / Snapshot / Image / DiskType — блочное хранение</td></tr>
  </tbody>
</table>
