...
<div className={hero.featureGrid}>
  ...
  <div className={hero.featureCard}>
    <span className={hero.featureIcon}>🔑</span>
    <span className={hero.featureTitle}>Авторизация через kacho-iam</span>
    <span className={hero.featureBody}>Per-RPC authz-гейт через kacho-iam: вердикт по отношению субъекта к ресурсу или его проекту.</span>
  </div>
  <div className={hero.featureCard}>
    <span className={hero.featureIcon}>▤</span>
