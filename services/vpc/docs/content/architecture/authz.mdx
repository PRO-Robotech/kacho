...
<table>
  ...
  <tbody>
    <tr><td><code>Get</code> / <code>GetByValue</code></td><td><code>v&#95;get</code></td><td>Сам ресурс</td></tr>
    ...
    <tr><td>Вложенный список (<code>ListBySubnet</code>, <code>ListOperations</code>, …)</td><td><code>v&#95;list</code></td><td>Объект-контейнер</td></tr>
...
(`NetworkService/ListSubnets` → `v_list` на `vpc_network`) — там у вопроса есть единый объект.
