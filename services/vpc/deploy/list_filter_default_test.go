...
//
// ПОЧЕМУ ЧИТАЮТСЯ ОБЪЯВЛЕНИЯ, А НЕ РЕНДЕР. Приём взят у пробы формы токена
// (deploy/helm/umbrella/token_shape_test.go): контракт — это то, что профиль ОБЪЯВЛЯЕТ; чтение
