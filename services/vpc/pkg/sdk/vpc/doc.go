...
// Package vpc предоставляет тонкую Go SDK-обертку над gRPC-stubs Kachō VPC
...
// (github.com/PRO-Robotech/kacho/pkg/api/kacho/cloud/vpc/v1). Чтобы
...
//
//	import (
//	    vpcsdk "github.com/PRO-Robotech/kacho/services/vpc/pkg/sdk/vpc"
...
//	defer c.Close()
//
//	resp, err := c.Networks.List(ctx, &vpcv1.ListNetworksRequest{ProjectId: "..."})
//
// # Long-running Operations
//
// Все мутации публичных VPC RPC возвращают operation.Operation.
...
//
// Внешний SDK живет в pkg/sdk/<service>/ как тонкая обертка; бизнес-логику в
// SDK не помещаем.
package vpc
