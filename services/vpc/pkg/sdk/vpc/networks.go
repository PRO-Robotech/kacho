...
// UpdateNetwork — async update (update_mask discipline: immutable-поля в маске
// дают InvalidArgument).
...
// DeleteNetwork — async hard-delete. RESTRICT-FK к Subnet/SG/RT: удалить
// можно только пустую сеть.
