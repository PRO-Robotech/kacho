...
# extracted from THIS reference gen.py. vpc uses the canonical helpers verbatim
# (no per-service param overrides) so the collections stay byte-identical.
...
# Step / Case declarative structures now live in tests/newman/shared/harness.py
# (imported above) — single canonical source shared by all services.
