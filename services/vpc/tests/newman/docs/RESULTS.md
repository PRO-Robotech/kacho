...
**100% PASS.** Объявленных known-failing в этой сюите нет — объявлявший их раздел снят
...
> при следующем прогоне» — прогон случился (2026-08-04, `out/security-group.json`), и
...
> 2026-08-04 (`out/internal-pool.json`) — 227 утверждений, **0 упавших**, ни одной записи
