...
CASES.append(Case(
    ...
    steps=[
        ...
        Step(name="bind", method="POST", path="/vpc/v1/networks/{{nbNetId}}/addressPoolBinding", internal=True,
...
CASES.append(Case(
    ...
    steps=[
        ...
        # 3. Bind network → pool.
        Step(name="bind", method="POST", path="/vpc/v1/networks/{{exhNetId}}/addressPoolBinding", internal=True,
