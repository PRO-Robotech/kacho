...
var fixtureFormLedger = map[string]int{
	...
	//
	// Снимается своим изменением: привести значения к форме и удалить эту
	// строку. Пока она стоит, класс в пакете не РАСТЁТ — новая негодная
	// фикстура сдвигает число и краснит гейт.
