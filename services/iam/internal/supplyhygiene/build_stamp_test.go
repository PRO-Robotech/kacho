...
//
// Класс не выдуман: в этом же дереве соседние процессы платформы объявляют такие
// же переменные, а подстановка до них не доходит — величина есть, производителя
// нет. СКОЛЬКО их, здесь не пишется: прежде тут стояло «четыре сервиса … ни одна
...
// он же ведёт ведомость остатка (#2527).
//
// ─────────────────────────────────────────────────────────────────────────────
