...
//
// Класс не выдуман: в этом же дереве четыре соседних сервиса объявляют такие же
// переменные, их комментарии обещают подстановку компоновщиком, и НИ ОДНА
// сборка дерева этого не делает. Величина есть, производителя нет.
//
// ─────────────────────────────────────────────────────────────────────────────
