...
func datingLedger() map[string]string {
	return map[string]string{
		"engineering/acceptance/credential-ceiling-per-principal.md": "APPROVED-приёмка: вердикт рецензента стоит на тексте, датировка правится своим заходом — задача #2043",
		"engineering/acceptance/expired-credential-reclaim.md":       "APPROVED-приёмка: вердикт рецензента стоит на тексте, датировка правится своим заходом — задача #2043",
	}
}
