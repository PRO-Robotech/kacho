...
// таком порядке:
//
//	шаг 5  UpsertResource  по ОБЪЯВЛЕННЫМ     (возрастающе)
//	шаг 8  RetireResource  по СНИМАЕМЫМ       (возрастающе)
//
...
// когда `WHERE` ветви `DO UPDATE` ложен и строка не меняется, поэтому шаг 5
