...
// prunedByReading — вырезанное у роли, прочитанное ЧЕРЕЗ ПОРТ, плюс объём
// осмотренного по всей ведомости.
//
// Две величины, а не одна: «у этой роли прочитано столько» не отличает «у роли
// пусто» от «путь чтения ничего не возвращает никому», и без общего числа строк
// ноль был бы получен даром.
