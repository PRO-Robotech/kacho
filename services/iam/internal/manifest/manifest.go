...
// спрашивает вовсе, и на месте того довода — тип объекта. Довод сменился, вывод
// уцелел; если однажды разомкнётся и таблица типов, вывод придётся пересматривать
// вместе с ним, а не наследовать.
//
