...
// minProseRunes — предел длины прозы, которую манифест пишет ЧЕЛОВЕКУ: описание
// роли, описание группы, описание служебной записи, причина устаревания глагола
// и предикат его снятия. Объявлен схемой (`minLength: 16`) у всех пяти сразу.
//
