...
// Применитель, переданный чужому пакету, который позвал бы применение у себя,
// этим гейтом не виден; такой формы в дереве нет, а появившись, она обязана быть
// учтена своим изменением. О ЧИСЛЕ применённых манифестов и об исходе применения
// гейт не судит вовсе — это предмет проб применителя против живой базы, а не
// дерева.
