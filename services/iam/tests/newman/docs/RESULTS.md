...
не работает, упавшее не мешает следующему пройти. Следствие для вердикта: зелёных
стало **13** вместо 20, и каждое из тринадцати о чём-то свидетельствует. Семь
красных — по предмету `#2191`, снимаются его закрытием.
