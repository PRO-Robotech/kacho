...
Coverage:
  ...
  IAM-OWNREST-NEG-FOREIGN-MUTATION — та же пара на МУТАЦИИ: отображение кода то же, а путь
                                     до двери другой — «читать нельзя, а править можно»
                                     проверяется только правкой
        ...
        Step(
            ...
            test_script=[
                *assert_status(200),
                ...
                "  pm.expect(JSON.stringify(j), JSON.stringify(j))",
                "    .to.include(pm.environment.get('userAAAId'));",
                "});",
                ...
                _CONTROL_OPEN,
                "  pm.expect(JSON.stringify(j), 'субъект не назван ВОВСЕ: «чужого идентификатора "
