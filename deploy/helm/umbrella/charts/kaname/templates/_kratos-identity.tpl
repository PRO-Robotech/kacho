...
{{- $host := ($h.host | default (printf "kaname-internal.%s.svc" .Release.Namespace)) -}}
  ...
  flows:
    ...
    registration:
      ...
      after:
        webauthn:
          hooks:
            # C4 fix: provisioning web_hook → kaname :9092 HTTP hooks
            # listener (Service kaname-internal). The previous target was
    ...
    login:
      ...
      after:
        webauthn:
          hooks:
            # C4 fix — provisioning web_hook → kaname :9092 HTTP route
