...
//     каталоги charts/). Хранилища Ory и OpenFGA держат свою строку соединения
//     сами, их послабление объявлено в шапке values.fe3455-prod.yaml, и решать
...
// а не списком имён. Хранилища Ory и OpenFGA сюда не попадают by construction —
