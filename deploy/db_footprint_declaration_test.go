...
var knownUndeclaredFootprint = map[string]string{
	// Три стенда объявляют боевую посадку, а посадку своих баз наследуют от
	// values.dev.yaml. Правка того профиля меняет условия, на которых снят
	// действующий отчёт замера и гоняется весь сквозной набор, — это
	// капасити-решение, требующее прогона на стенде, а не правки файла.
	// Разбор, числа и предикат снятия — в #808.
	"a8f60d/pg-vpc/" + kindOverspend:          "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"a8f60d/pg-compute/" + kindOverspend:      "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"a8f60d/pg-nlb/" + kindOverspend:          "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"a8f60d/pg-geo/" + kindOverspend:          "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"a8f60d/pg-registry/" + kindNoBudget:      "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
	"a8f60d/pg-storage/" + kindNoBudget:       "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
	"dev-prod/pg-vpc/" + kindOverspend:        "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"dev-prod/pg-compute/" + kindOverspend:    "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"dev-prod/pg-nlb/" + kindOverspend:        "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"dev-prod/pg-iam/" + kindOverspend:        "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"dev-prod/pg-registry/" + kindNoBudget:    "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
	"dev-prod/pg-storage/" + kindNoBudget:     "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
	"prorobotech/pg-vpc/" + kindOverspend:     "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"prorobotech/pg-compute/" + kindOverspend: "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"prorobotech/pg-nlb/" + kindOverspend:     "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"prorobotech/pg-iam/" + kindOverspend:     "#808 — предмет: посадка баз, унаследованная от профиля разработки",
	"prorobotech/pg-registry/" + kindNoBudget: "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
	"prorobotech/pg-storage/" + kindNoBudget:  "#808 — предмет: pg-registry/pg-storage не настроены ни одним профилем дерева",
}
