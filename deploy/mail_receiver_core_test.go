...
// отдельно — deploy/tests/helm/identity-mail-lane-guard-inject.sh.
//
// Координата ЗДЕСЬ СТОЯЛА без приставки каталога и от корня дерева не
// резолвилась: доказательство существует, а искать его посылало не туда.
// Соседние пробы этого же каталога пишут путь от корня — так и надо, иначе
// координата есть утверждение о дереве, которое нельзя проверить.
