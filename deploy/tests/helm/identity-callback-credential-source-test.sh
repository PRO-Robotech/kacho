...
# (deploy/identity_callback_transport_test.go) судит ОБЪЯВЛЕНИЯ и потому видит
# полосы, которые сегодня никто не монтирует; этот судит ПОДЫ и потому видит
# источник величины. Оси разные, и обе нужны.
#
