...
setval "$TMP/no-reader/values.prod.yaml" '.["kaname"].platform.iam.saKey.bindDpop = true'
...
setval "$TMP/has-reader/values.dev.yaml" '.["kaname"].platform.iam.saKey.bindDpop = true'
