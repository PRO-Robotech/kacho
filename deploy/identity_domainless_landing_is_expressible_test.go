...
//     `.Values.global`, поэтому рендер подчарта kacho-iam с цепочкой профилей
...
const iamSubchartDir = umbrellaDir + "/charts/kacho-iam"

// renderIdentitySubchart рендерит подчарт kacho-iam с перечисленными файлами
