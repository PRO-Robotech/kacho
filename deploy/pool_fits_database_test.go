...
var knownUnfitting = map[string]string{
	"prod/pg-vpc":   "#762 — предмет vpc: предел базы не объявлен профилем, пул его превышает",
	"fe3455/pg-vpc": "#762 — предмет vpc: предел базы не объявлен профилем, пул его превышает",
}
