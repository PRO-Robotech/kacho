...
// MAIL-18 (identity_delivery_flows_declared_once_test.go) на ЭФФЕКТИВНОМ наборе
// стенда. Здесь она не воспроизводится: два места об одном предмете разошлись бы
// молча, и это ровно тот класс, который обе проверки ловят.
//
