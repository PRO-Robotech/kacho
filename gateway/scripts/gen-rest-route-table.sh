...
OUT_DEFAULT="${REPO_ROOT}/internal/middleware/rest_route_table_gen.go"
OUT="${1:-${OUT_DEFAULT}}"
...
kacho_assemble_contract_root "${PROTO_ROOT}" "${CONTRACT_ROOT}" "${GEN_MODULE_DIR}" "rest-route-table"
