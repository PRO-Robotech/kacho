...
// subject_change_wiring_test.go — ПРОДОВАЯ точка сборки читателя отзыва
...
func (idlePoller) PollSubjectChanges(_ context.Context, _ int64, _ int32) ([]watcher.SubjectChange, int64, error) {
	return nil, 0, nil
}
