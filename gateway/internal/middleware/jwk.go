...
var (
	...
	// ErrUnknownCriticalHeader — отправитель пометил параметр обязательным к
	// пониманию, а мы его не исполняем (RFC 7515 §4.1.11). Принять такой токен
	// значит согласиться с условием, которого не проверил.
