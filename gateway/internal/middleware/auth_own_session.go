...
//
// # На глаголах формы полоса отличается РОВНО ОДНИМ исходом (Р7, Р16)
//
...
// — F4d-23 (Ф3-20 «д»). Регистрация (Ф4) и оба глагола восстановления (Ф5)
// состояния под сессией носителя не меняют — регистрация заводит новую личность,
// восстановление ключуется кодом, — поэтому недоступность на них
// ретранслируется, как на входе. Ветка читает то же объявление путей, которым
