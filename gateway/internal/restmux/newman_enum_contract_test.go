...
var enumValueWaiver = map[string]string{
	...
	"SG-URL-VAL-DIRECTION-UNKNOWN additionRuleSpecs[0].direction": "проба и есть отказ на направлении вне словаря; её утверждение принимает и 200, и 400 — то есть отказаться она не может (находка для владельца vpc, вне зоны этой правки)",
}
