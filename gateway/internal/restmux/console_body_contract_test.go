...
var bespokeConsoleMutationSites = map[string]string{
	...
	// теми же глаголами полосы входа, либо ответу, который подставила сама проба.
	"e2e/specs/ceremony-seed.ts":                   "посев «Дано» проб F8 глаголами полосы входа своим контекстом запросов, тело — форма службы",
	"e2e/specs/answer-on-arrival.spec.ts":          "страница пробы шлёт тело петлевому серверу самой пробы, край в этом не участвует",
	"e2e/specs/registration-refusal-named.spec.ts": "страница пробы шлёт регистрацию на ответ, подставленный перехватом, край в этом не участвует",
