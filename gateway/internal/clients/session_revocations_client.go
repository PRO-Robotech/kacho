...
//
// До появления этого вызывающего наш отзыв не участвовал в решении на пути
// запроса вовсе: запись писалась и читалась только административными путями
// (#797). Сегодня это ЕДИНСТВЕННЫЙ источник полосы записи отзыва: прежний
// поставщик, которого спрашивали следом, снят (#2734).
//
