...
//     величин не выводится: здесь стояло «край ВЫВОДИТ издателя из домена API
//     по умолчанию», и пока выводил, состояние «якорь доверия не объявлен» не
//     наступало ни при какой посадке — край поднимался и забирал проверочные
//     ключи по адресу, которого ему никто не давал. Неполный пин ⇒ отказ;
