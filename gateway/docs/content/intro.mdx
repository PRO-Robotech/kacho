...
<div className={hero.featureGrid}>
  ...
  <div className={hero.featureCard}>
    ...
    <span className={hero.featureBody}>JWKS, introspection, DPoP-replay, authz-decision — все LRU + TTL; кэш решений гейтвей гасит сам, читая журнал смены субъекта у kacho-iam.</span>
  </div>
</div>
