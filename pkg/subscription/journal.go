...
const (
	...
	// УДЕРЖИВАЕТСЯ.
	//
	// Производителя в дереве сегодня НЕТ: оба владельца объявляют
	// [RetainsEverything]. Значение объявлено потому, что объявлено контрактом, и
	// владельцу, заведшему чистку журнала, будет чем назвать этот исход, — а не
	// «на будущее»: без него он назвал бы соседнее.
	StateNotRetained
