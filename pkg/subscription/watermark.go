...
func (h *watermark) observe(maxSeq, minSeq int64, writers []string) {
	...
	// Наблюдение состоялось, когда подтверждать больше нечего: либо прошлое
	// подтверждено, либо ожидания не заводилось вовсе (писателей не было, либо
	// журнал пуст и максимума в нём нет).
