...
const (
	// noticeMuteProducer — единственный файл дерева, глушащий порог сессии.
	// Назван координатой, чтобы проба ИСТЕКАЛА вместе с ним.
...
func requireMuteProducerStillExists(t *testing.T) {
	...
	require.NoErrorf(t, err, "производитель класса %s не прочитан: проба без производителя "+
		"воспроизводила бы факт, которого в дереве нет", noticeMuteProducer)
