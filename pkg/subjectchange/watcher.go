...
//
// РЕПЛИКИ: петля гасит кэш СВОЕГО процесса и держит курсор в памяти. Каждая
// реплика обязана читать сама: разведи её — и кэш невыбранных реплик не погаснет
// вовсе, то есть отозванный доступ продолжит действовать.
