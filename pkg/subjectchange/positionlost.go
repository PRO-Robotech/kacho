...
//
// #nosec G101 -- признак полосы отказа, уезжающий клиенту в деталях ответа, а не
// секрет. Эвристика статического анализа ключуется на форме имени — заглавные с
// подчёркиваниями рядом со строковым литералом — и не различает токен публичного
// контракта от учётных данных.
