...
type Registration struct {
	...
	//
	// Пусто — законный вход: сервис, у которого цепь совпадает с двумя полями
	// выше, её не дублирует, и принимающая сторона выводит предков как раньше.
	// Заполнять её обязан тот, у кого иерархия глубже двух уровней.
	ParentChain []string
