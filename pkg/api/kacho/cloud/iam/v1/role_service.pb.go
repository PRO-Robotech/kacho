...
const file_kacho_cloud_iam_v1_role_service_proto_rawDesc = "" +
	...
	"operations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\x80\t\n" +
	"\vRoleService\x12\x86\x01\n" +
	"\x03Get\x12\".kacho.cloud.iam.v1.GetRoleRequest\x1a\x18.kacho.cloud.iam.v1.Role\"A\x8a\xb5\x18\b<exempt>\xba\xb5\x18\x12SERVICE_SIDE_AUTHZ\x82\xd3\xe4\x93\x02\x19\x12\x17/iam/v1/roles/{role_id}\x12\x80\x01\n" +
	"\x04List\x12$.kacho.cloud.iam.v1.ListRolesRequest\x1a%.kacho.cloud.iam.v1.ListRolesResponse\"+\x8a\xb5\x18\x0eiam.roles.list\xb0\xb5\x18\x01\x82\xd3\xe4\x93\x02\x0f\x12\r/iam/v1/roles\x12\xc5\x01\n" +
