...
const file_kacho_cloud_iam_v1_service_account_service_proto_rawDesc = "" +
	...
	"\x06labels\x18\x04 \x03(\v2;.kacho.cloud.iam.v1.CreateServiceAccountRequest.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\x06labels\x18\x05 \x03(\v2;.kacho.cloud.iam.v1.UpdateServiceAccountRequest.LabelsEntryR\x06labels\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"operations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\x91\x11\n" +
	...
	"\x13iam_service_account\x12\x12service_account_id\xa2\xb5\x18\x011\x82\xd3\xe4\x93\x02.\x12,/iam/v1/serviceAccounts/{service_account_id}\x12\xa9\x01\n" +
	"\x04List\x12..kacho.cloud.iam.v1.ListServiceAccountsRequest\x1a/.kacho.cloud.iam.v1.ListServiceAccountsResponse\"@\x8a\xb5\x18\x19iam.service_accounts.list\xb0\xb5\x18\x01\x82\xd3\xe4\x93\x02\x19\x12\x17/iam/v1/serviceAccounts\x12\xf9\x01\n" +
