...
const (
	QuotaService_List_FullMethodName = "/kacho.cloud.registry.v1.QuotaService/List"
)
...
type QuotaServiceClient interface {
	...
	// two kinds for this domain — and it is bounded by a migration, not by tenant
...
var QuotaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kacho.cloud.registry.v1.QuotaService",
	...
	Metadata: "kacho/cloud/registry/v1/quota_service.proto",
}
