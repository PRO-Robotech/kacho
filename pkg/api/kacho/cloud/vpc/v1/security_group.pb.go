...
const file_kacho_cloud_vpc_v1_security_group_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\b\x10\tR\x06status\"\xfe\x04\n" +
	...
	"cidrBlocks\x12,\n" +
	"\x11security_group_id\x18\t \x01(\tH\x00R\x0fsecurityGroupId\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0ev6_cidr_blocks\x18\x02 \x03(\tR\fv6CidrBlocksB@Z>github.com/PRO-Robotech/kacho/pkg/api/kacho/cloud/vpc/v1;vpcv1b\x06proto3"
