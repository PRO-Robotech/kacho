...
type Subnet struct {
	...
	// ID of the project that the subnet belongs to.
...
const file_kacho_cloud_vpc_v1_subnet_proto_rawDesc = "" +
	"\n" +
	"\x1fkacho/cloud/vpc/v1/subnet.proto\x12\x12kacho.cloud.vpc.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x05\n" +
	"\x06Subnet\x12\x0e\n" +
	...
	"J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\r\x10\x0eJ\x04\b\x14\x10\x15R\fdhcp_optionsR\vapply_state*U\n" +
	...
	"\x04IPV6\x10\x02B@Z>github.com/PRO-Robotech/kacho/pkg/api/kacho/cloud/vpc/v1;vpcv1b\x06proto3"
