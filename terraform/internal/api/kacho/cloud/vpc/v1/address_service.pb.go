...
const file_kacho_cloud_vpc_v1_address_service_proto_rawDesc = "" +
	...
	"\vvpc_address\x12\n" +
	"address_id\xa2\xb5\x18\x011\x82\xd3\xe4\x93\x02+\x12)/vpc/v1/addresses/{address_id}/operationsB\xe7\x01\n" +
	"\x16com.kacho.cloud.vpc.v1B\x13AddressServiceProtoP\x01ZMgithub.com/PRO-Robotech/kacho/terraform/internal/api/kacho/cloud/vpc/v1;vpcv1\xa2\x02\x03KCV\xaa\x02\x12Kacho.Cloud.Vpc.V1\xca\x02\x12Kacho\\Cloud\\Vpc\\V1\xe2\x02\x1eKacho\\Cloud\\Vpc\\V1\\GPBMetadata\xea\x02\x15Kacho::Cloud::Vpc::V1b\x06proto3"
