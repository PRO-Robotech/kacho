...
moved {
  from = kacho_iam_role.this
  to   = kaname_role.this
}

moved {
  from = kacho_iam_access_binding.group
  to   = kaname_access_binding.group
}

moved {
  from = kacho_iam_access_binding.subject
  to   = kaname_access_binding.subject
}
