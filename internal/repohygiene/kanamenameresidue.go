...
var KanameNameResidueDebt = []NameResidueDebt{
	...
	{laneChartKnob, 85, 9, "линия дебрендинга: ключи чарта оператора"},
	...
	{laneObjectName, 596, 216, "Р3 эпика #2076 — витрина оператора"},
	{laneBrandInText, 99, 76, "Р3 эпика #2076 — бренд в прозе и на клиентских страницах"},
	{lanePlatformName, 611, 278, "Р3 эпика #2076 — имя платформы отдельным словом"},
