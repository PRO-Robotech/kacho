...
var KanameNameResidueDebt = []NameResidueDebt{
	...
	{laneChartKnob, 132, 14, "линия дебрендинга: ключи чарта оператора"},
	...
	{laneDomainAddress, 575, 168, "Р10 №2 — домен доверия и адреса стенда"},
	{laneObjectName, 615, 220, "Р3 эпика #2076 — витрина оператора"},
	{laneBrandInText, 99, 76, "Р3 эпика #2076 — бренд в прозе и на клиентских страницах"},
	{lanePlatformName, 638, 292, "Р3 эпика #2076 — имя платформы отдельным словом"},
	{borderUnknownForm, 70, 31, "слепая зона распознавателя: рост числа означает новую форму записи"},
}
