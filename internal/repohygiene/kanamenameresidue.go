...
//
// Ведомость движется ТОЛЬКО ВНИЗ, и перемер это подтвердил: из пятнадцати строк
// четыре опустились, одиннадцать сошлись с фактом дословно, НИ ОДНА не выросла.
...
var KanameNameResidueDebt = []NameResidueDebt{
	{laneContractCoordinate, 452, 37, "#2133 — имя пакета контракта следует за продуктом (Р14)"},
	...
	{lanePlatformName, 619, 282, "Р3 эпика #2076 — имя платформы отдельным словом"},
