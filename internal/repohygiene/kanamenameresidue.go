...
// нет ни рядом с деревом, ни рядом с рабочей копией; все пять целей отказывали на
// первом же `cp`. Вместе с целями ушли комментарии их `.gitignore`, называвшие тот
// же несуществующий источник, — и один файл выбыл из полосы целиком.
//
