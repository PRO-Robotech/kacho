...
var KanameNameResidueDebt = []NameResidueDebt{
	...
	{laneClaimAssertion, 97, 28, "О1 эпика #2076 — межрепозиторный контракт, требует окна двух написаний"},
	...
	{lanePlatformName, 313, 119, "Р3 эпика #2076 — имя платформы отдельным словом"},
