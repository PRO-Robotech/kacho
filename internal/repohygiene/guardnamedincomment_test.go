...
var guardedIdentifiers = []guardedIdentifier{
	{
		name:       "ClosedVerbs",
		why:        "словарь глаголов: комментарий, называющий его закрывающим сегмент, отвечает за читателя на вопрос о наличии проверки",
		retireWhen: "идентификатор удалён из дерева (набор читается у типа) — тогда и упоминать его как действующую защиту негде",
	},
	{
		name:       "IsClosedVerb",
		why:        "проверка принадлежности глагола: то же — упоминание закрывает вопрос вместо проверки",
