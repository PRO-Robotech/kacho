...
//
// СЕГОДНЯ ЗДЕСЬ ПУСТО, и это измерение, а не забытая карта: два значения,
// которым тут было бы место (`jit_revoke`, `bg_revoke`), сняты с ограничения
// миграцией 754001 вместе со своим объявлением — исход «снять», а не «простить».
