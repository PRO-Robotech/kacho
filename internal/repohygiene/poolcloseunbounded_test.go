...
var poolCloseDebt = map[string]int{
	...
	//
	// 462 → 461 (сведение цепочки iam, 2026-09-04): ещё одно ушло вместе с
	...
	// ступеней не стало. Пробы сняты вместе с предметом, а закрытие пула ушло с
	// ними — оно принадлежало помощнику лестницы, а не проверяемому свойству.
	"services/iam": 461,
