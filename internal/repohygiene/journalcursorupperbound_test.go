...
//
// # ЗАПИСИ РАЗОШЛИСЬ ПО ПРЕДМЕТУ, а не по объёму работы
//
// Журнал изменений субъекта (kacho#1374) несёт класс ЖИВЫМ: номер приходит голым
// `nextval`, и потеря воспроизводима.
//
