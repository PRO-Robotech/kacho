...
`
	injProducerImport = `import "github.com/PRO-Robotech/kacho/services/iam/internal/repo/kacho/pg/resource_mirror"
`
...
func TestInjection_AliasedProducerImportIsStillRecognised(t *testing.T) {
	src := `import rm "github.com/PRO-Robotech/kacho/services/iam/internal/repo/kacho/pg/resource_mirror"
...
func TestInjection_SameNamedFunctionOfAnotherPackageIsNotTheProducer(t *testing.T) {
	src := `import "github.com/PRO-Robotech/kacho/services/iam/internal/repo/kacho/pg/target_members"
