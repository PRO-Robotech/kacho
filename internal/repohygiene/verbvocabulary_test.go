...
var verbLiteralRoster = []verbLiteral{
	...
	},
	{
		...
		claims: "что выпадающий список редактора ролей предлагал КАЖДОМУ ресурсу до появления " +
			...
			"любом сужении",
		checkedBy: "тот же файл: TestCatalogResourceVerbs_NobodyLostWhatTheEditorUsedToOffer — " +
			"каждый глагольный ресурс предлагает не меньше, кроме поимённо суженных с причиной",
