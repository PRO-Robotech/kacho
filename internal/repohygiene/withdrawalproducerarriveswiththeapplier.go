...
//
// Сильнее того: глагол применения (`#1034`) уже решил, что загрузка на старте
// СВЕРЯЕТ и **отказывает в старте при расхождении**. Значит применение,
// приехавшее без производителя отзыва, превращает обычную правку манифеста
// (роль убрана из раздела) в неподнимающийся iam — и выход из этого состояния
// снова требует выкатки образа.
//
...
const applierImportPath = "github.com/PRO-Robotech/kacho/services/iam/internal/apps/kacho/moduleroles"
