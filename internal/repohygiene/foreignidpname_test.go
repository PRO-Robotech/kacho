...
var foreignIDPNameLedger = []ForeignIDPNameLedgerEntry{
	{
		Area: "gateway/",
		// Снято обходом головы ветки #2815 (было 102 на 5b20df5c638): снятие
		// смешанного состояния носителя и скалярного пина издателя увело имена
		// этой оси из конфигурации и проб, а новые функции провязки читателя
		// носителя адрес поставщика его именем не называют.
		Names:    94,
		Measured: "432b3278151",
