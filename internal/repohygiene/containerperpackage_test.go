...
// modulePath — префикс импортов этого модуля, чтобы перевести путь импорта в каталог.
...
// `kachopg.` — предикат по имени пропустил бы восемь мест в двух пакетах (замерено
