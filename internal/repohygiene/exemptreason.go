...
var EnforcementSite = map[string]string{
	"kacho.cloud.iam.v1.AccountService/List":         "services/iam/internal/apps/kacho/api/account/list.go",
	"kacho.cloud.iam.v1.ProjectService/List":         "services/iam/internal/apps/kacho/api/project/list.go",
	"kacho.cloud.iam.v1.UserService/List":            "services/iam/internal/apps/kacho/api/user/list.go",
	"kacho.cloud.iam.v1.GroupService/List":           "services/iam/internal/apps/kacho/api/group/list.go",
	"kacho.cloud.iam.v1.ServiceAccountService/List":  "services/iam/internal/apps/kacho/api/service_account/list.go",
	"kacho.cloud.iam.v1.RoleService/List":            "services/iam/internal/apps/kacho/api/role/list.go",
	...
	"kacho.cloud.iam.v1.AccessBindingService/Create": "services/iam/internal/apps/kacho/api/access_binding/create.go",
