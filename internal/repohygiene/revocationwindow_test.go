...
// видит сервис, приехавший с новым именем: седьмой сервис унаследовал бы окно
// молча и не измерялся бы ничем. Здесь вопрос задан без словаря — «строит ли
// этот сервис кеш вердиктов вообще», — поэтому новый сервис ловится в день
// появления, а не в день, когда кто-то вспомнит дополнить список.
