...
var tableGrowthRegistry = []TableGrowthDecl{
	...
	},
	{
		...
		Reason: "журнал намерений, ПЕРЕСТАВШИЙ быть очередью: колонки доставки сняты " +
			...
			"для `audit_outbox`, свидетельства той же природы и более быстрого роста " +
			"(оно пишется на каждой мутации, этот — только на смене отношений); решить " +
			"здесь иначе значило бы дать продукту разойтись с самим собой. Разбор — " +
