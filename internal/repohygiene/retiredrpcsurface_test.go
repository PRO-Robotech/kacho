...
var retiredRPCSurface = []RetiredRPC{
	...
	},
	{
		...
		Reason: "запись в хранилище кортежей чужого движка. Намерение об отношении кладётся " +
			"строкой журнала `kacho_iam.fga_outbox`, из которой триггер складывает прямой факт " +
			"в той же транзакции; писать «мимо журнала» больше некуда и незачем.",
	},
	{
