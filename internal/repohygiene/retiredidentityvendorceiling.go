...
var retiredVendorCeilings = map[string]int{
	// платформа: 1643 строк — по пути 20 · по имени 1573 · склейкой 1 · по
	...
	//
	// ПЕРЕСЧЁТ #2733: 1643 = 1704 − 61 + 0. Потолок СНИЖЕН. Оба числа сняты
	// этим гейтом в ветке `2735`: 1704 — на a6efbf88c7b (число равно записи),
	// 1643 — на изменении консоли поверх него. Код гейта и проб тот же; служба
	// доступа и фундамент не изменились (1107 и 0). Вся убыль — в `ui-future/**`
	// (область 164 → 103), прироста нет. По файлам, разностью перечней адресов
	// двух прогонов:
	//
	...
	//	консоль     страница доступности 1 и её проба 1 · исключение словаря
	//	            языка интерфейса 1
