...
var tfModuleExempt = map[string]string{
	"kacho_iam_account": "аккаунт — корень арендной иерархии, ВНУТРИ которого исполняется сам модуль. " +
	...
	"kacho_iam_user_token": "токен — недолговечное удостоверение, а не часть ландшафта, и в модуле " +
...
# resource "kacho_iam_account" "commented_hash" {}
// resource "kacho_iam_role" "commented_slash" {}

/*
resource "kacho_iam_user_token" "commented_block" {}
*/
