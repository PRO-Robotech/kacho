...
// цепочку.
//
// Проводок ШЕСТЬ, рубежей ПЯТЬ: политика вызывающего — один рубеж, но у неё своя
// реализация на каждом слушателе, и обе обязаны быть на месте. «На внутреннем
// есть, на публичном нет» — это не «рубеж ослаб наполовину», а дыра целиком на
// той поверхности, где её нет.
//
