...
# Reseed if missing, forced, or STALE: the issuer mints SA access tokens with a 900s
...
# `kaname.fga_outbox` читает триггер, складывающий прямой факт В ТОЙ ЖЕ транзакции,
