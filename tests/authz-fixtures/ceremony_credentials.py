...
CEREMONY_ONLY_ENV: dict[str, str] = {
    ...
    "jwtHumanCeremonyStepUp": (
        "тот же человек с ПОДНЯТЫМ уровнем аутентификации. Уровень поднимается только "
        "церемонией входа; машинному принципалу его не назначить — и не нужно "
        "(правило повышения снимает порог с машины целиком, до сравнения уровня)."
    ),
