...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    p.add_argument("--proto-glob", required=True,
                   help="glob for .proto files; contracts of the access service live "
                        "in module github.com/PRO-Robotech/kaname (e.g. "
                        "\"$(go list -m -f '{{.Dir}}' github.com/PRO-Robotech/kaname)"
