...
def retry_until_authorized(step, budget: int, interval_ms: int,
                           retry_on=(403, 404), extra_head=(), ledger=None):
    ...
    расхождением по существу:
      ...
      * ДВЕ ТОЧКИ ВСТАВКИ (`extra_head`, `ledger`) — добавки, которые несёт по
        одному набору. Названы полями, а не спрятаны в двух копиях тела;
